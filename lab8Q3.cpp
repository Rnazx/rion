...
void sorter(int arr[], int k){
	...
	cout <<"]"<<endl;;
	cout<<k<<"The smallest element of the array is:"<<sortarr[k-1]<<endl;
	cout<<k<<"The largest element of the array is:"<<sortarr[7-k]<<endl;
}

//main fn
int main(){
	int arr[7]={5,4,7,11,13,2,5};
	int k;
	cout <<"Array: [5,4,7,11,13,2,5]"<<endl;
	cases:
